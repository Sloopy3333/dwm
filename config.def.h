...
static const char col_grey[]              = "#586e75";
...
static const char col_purple[]           =  "#6c17c4";

static const char *colors[][3]      = {
  /*               fg         bg         border   */
  [SchemeNorm] = { col_fg,    col_bg,  col_bg },
  [SchemeSel]  = { col_yellow, col_bg,  col_grey },
};
...
static Key keys[] = {
  ...
  // gaps and fullscreen
  { MODKEY|ControlMask,           -1,         XK_f,                         togglebar,      {.f = +0.05} },
  ...
  { MODKEY|ShiftMask,             -1,         XK_x,                         spawn,          SHCMD("slock")},
